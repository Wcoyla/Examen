...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        <h3>Categorias</h3>
    <p>
        CategotyID: <asp:TextBox runat="server" Id="txtCategoryID"/>
    </p>
    <p> 
        CategoryName: <asp:TextBox runat="server" Id="txtCategoryName"/>
    </p>
    <p> 
        Description: <asp:TextBox runat="server" Id="txtDescription"/>
    </p>
    <p> 
    ...
    <p> 
        <asp:GridView runat="server" ID="gvCategoria" CssClass="mGrid"></asp:GridView>
    </p>
    </body>
    </html>
    <style>
